...
<?php $id=1; if(isset($_GET['id'])) $id=$_GET['id']; ?>
<!doctype html>
...
<?php $editMerit = Merit::getByMeritId($id); print_r($editMerit); ?>
<!-- Main Content -->
<section class="content home">
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <form action="edit-merits.php" method="post" enctype="multipart/form-data" onsubmit="closeKeepAlive()">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" name="title" id="title" class="form-control" placeholder="Name" value="<?php echo $editMerit->title; ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" name="action" id="action" class="form-control" placeholder="Action" value="<?php echo $editMerit->action; ?>">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="achievement" id="achievement" class="form-control" placeholder="Achievement" value="<?php echo $editMerit->achievement; ?>"></input>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-6 form-group">
                                ...
                                <div class="radio inlineblock <?php if($dummy==0) echo 'm-r-25';?>">
                                    <input type="radio" name="frequency" id="radio<?php echo $f->id; ?>" value="<?php echo $f->id; ?>" <?php if($editMerit->frequency == $f->id) echo 'checked' ?>>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    $dummy = 0;
                                    foreach ($types as $t){ ?>
                                        <option value="<?php echo $t->id; ?>" <?php if($editMerit->frequency == $t->id) echo 'selected' ?>><?php echo $t->title; ?></option>
                                        <?php $dummy++; } ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-3 col-dm-3 col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="value" placeholder="Value of Merit" value="<?php echo $editMerit->value; ?>">
                                    <input type="hidden" name="id"  value="<?php echo $editMerit->id; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
